...
TEST(test_ir, pnnx_graph_ops) {
   ...
   */
  std::string bin_path("/code/kuiperdatawhale/course3/model_file/test_linear.pnnx.bin");
  std::string param_path("/code/kuiperdatawhale/course3/model_file/test_linear.pnnx.param");
